...
public class XBMCSearchableActivity extends Activity
{
  ...
  public void onNewIntent(Intent intent)
  {
    ...
    if (appData != null)
    {
      Log.d(TAG, "onNewIntent: We have extra search data: ");
  ...
  private void search(String query)
  {
    Cursor c = getContentResolver().query(
        Uri.parse("content://com.semperpax.spmc17.media/search/" + query), null, null,
        null, null);
  ...
  private void doAction(Intent origIntent)
  {
    ...
    newIntent.setClass(this, com.semperpax.spmc17.Main.class);
