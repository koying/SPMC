...
public:
  ...
  virtual void* create_stf(CXBMCApp* xbmcapp, CWinSystemEGL* windowing, CAdvancedSettings* advsettings)=0;
...
{
  DECLARE_DLL_WRAPPER(DllLibStageFrightCodec, DLL_PATH_LIBSTAGEFRIGHTVPU)
  DEFINE_METHOD3(void*, create_stf, (CXBMCApp* p1, CWinSystemEGL* p2, CAdvancedSettings* p3))
