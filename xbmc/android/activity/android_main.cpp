...
extern "C" JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
  ...
  jclass cMain = env->FindClass("hk/minix/xbmc/Main");
  if(cMain)
  {
    JNINativeMethod mOnNewIntent = {
      "_onNewIntent",
      "(Landroid/content/Intent;)V",
      (void*)&CJNIXbmcMainActivity::_onNewIntent
    };
    env->RegisterNatives(cMain, &mOnNewIntent, 1);
  }

  jclass cBroadcastReceiver = env->FindClass("hk/minix/xbmc/XBMCBroadcastReceiver");
  ...
  jclass cFrameAvailableListener = env->FindClass("hk/minix/xbmc/XBMCOnFrameAvailableListener");
